...
│                   Orchestrator (CLI)                 │
│                                                     │
│  scan repo → plan batches → launch sessions → poll  │
│  → merge gates → auto-merge PRs → final summary     │
└──────────┬──────────────┬──────────────┬────────────┘
           │              │              │
     ┌─────▼─────┐  ┌────▼────┐  ┌──────▼──────┐
     │ Phase 0   │  │ Phase 1 │  │  Phase 2    │
     │Foundation │  │ Parallel│  │Consolidation│
     │           │  │ Batches │  │             │
     │ Analyse   │  │ Tier 1  │  │ Run tsc     │
     │ repo,     │  │ Tier 2  │  │ Fix cross-  │
     │ create    │  │ Tier 3  │  │ batch type  │
     │ src/types │  │ Tier 4  │  │ mismatches, │
     │ + tsconfig│  │         │  │ deduplicate │
     └─────┬─────┘  └────┬────┘  └──────┬──────┘
           │              │              │
      merge gate     merge gate      cleanup PR
           │              │
    ▼ batches start  ▼ consolidation starts
```
